...
#include "../../../src/qtpropertybrowser/fileeditfactory.h"
...
namespace {
struct qt_meta_tag_ZN15FileEditFactoryE_t {};
} // unnamed namespace

template <> constexpr inline auto FileEditFactory::qt_create_metaobjectdata<qt_meta_tag_ZN15FileEditFactoryE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QtProperty *, const QString &)>(6, 2, QMC::AccessPrivate, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<FileEditFactory, qt_meta_tag_ZN15FileEditFactoryE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject FileEditFactory::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15FileEditFactoryE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15FileEditFactoryE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15FileEditFactoryE_t>.metaTypes,
    nullptr
} };
...
void *FileEditFactory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15FileEditFactoryE_t>.strings))
